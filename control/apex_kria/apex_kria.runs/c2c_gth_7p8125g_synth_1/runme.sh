...
HD_PWD='/home/agreshil/vivado_projects/fw_i2c_master/apex/control/apex_kria/apex_kria.runs/c2c_gth_7p8125g_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c2c_gth_7p8125g.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c2c_gth_7p8125g.tcl
