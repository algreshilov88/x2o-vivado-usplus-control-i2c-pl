...
HD_PWD='/home/agreshil/vivado_projects/fw_i2c_master/apex/control/apex_kria/apex_kria.runs/bd_0412_xsdbm_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_0412_xsdbm_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_0412_xsdbm_0.tcl
