...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_bit_ctrl is
  port (
    ...
    wr_data_stop_reg : in STD_LOGIC_VECTOR ( 1 downto 0 );
    done : in STD_LOGIC;
...
\FSM_sequential_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => CO(0),
      I5 => wr_data_stop_reg(1),
      O => \FSM_sequential_state_reg[1]\(0)
    );
\FSM_sequential_state[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFF0D0D0D0D0"
    )
        port map (
...
wr_data_stop_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => wr_data_stop_reg(0),
      I1 => wr_data_stop_i_2_n_0,
      I2 => wr_data_stop_reg_0(0),
      I3 => \FSM_sequential_state_reg[0]_1\,
      I4 => wr_data_stop_reg(1),
      I5 => wr_data_stop_reg_1,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_byte_ctrl is
  port (
    ...
    wr_data_stop_reg_0 : in STD_LOGIC_VECTOR ( 1 downto 0 );
    CO : in STD_LOGIC_VECTOR ( 0 to 0 );
    \FSM_sequential_state_reg[0]_1\ : in STD_LOGIC;
    \sr_reg[7]_0\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
    err : in STD_LOGIC;
    wr_data_stop_reg_1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    i2c_scl_i : in STD_LOGIC;
    i2c_sda_i : in STD_LOGIC
  );
...
bit_controller: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_bit_ctrl
     port map (
      ...
      \FSM_sequential_state_reg[0]_1\ => \^fsm_onehot_state_reg[0]\,
      ...
      wr_data_stop_reg(1 downto 0) => wr_data_stop_reg_0(1 downto 0),
      wr_data_stop_reg_0(0) => wr_data_stop_reg_1(0),
      wr_data_stop_reg_1 => wr_data_stop_reg
    );
cmd_ack_reg: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
...
byte_controller: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_byte_ctrl
     port map (
      ...
      Q(2) => \^fsm_onehot_state_reg[3]_0\(0),
      ...
      wr_data_stop_reg_0(1 downto 0) => Q(1 downto 0),
      wr_data_stop_reg_1(0) => wr_data_stop_reg_0(0)
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_config is
  ...
  attribute SOFT_HLUTNM of i2c_write_req_i_1 : label is "soft_lutpair39";
  ...
  attribute SOFT_HLUTNM of \slv_reg0[0]_i_1\ : label is "soft_lutpair39";
