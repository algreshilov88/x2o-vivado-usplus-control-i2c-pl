...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_bit_ctrl is
  port (
    ...
    cmd_ack_reg_0 : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_bit_ctrl is
  ...
  attribute SOFT_HLUTNM of alost_i_1 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of busy_i_1 : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \filter_cnt[0]_i_1\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of wr_data_stop_i_3 : label is "soft_lutpair20";
begin
...
\error_i_1__0\: unisim.vcomponents.LUT6
    generic map(
...
i2c_write_req_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFF0F5F00000404"
    )
        port map (
      I0 => Q(1),
      I1 => i2c_write_req_reg,
      I2 => Q(0),
      I3 => wr_data_stop_i_3_n_0,
      I4 => p_1_in0,
...
wr_data_stop_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_byte_ctrl is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[7]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \FSM_onehot_state[8]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[2]_i_3\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[2]_i_4\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \FSM_sequential_c_state[2]_i_5\ : label is "soft_lutpair31";
  attribute FSM_ENCODED_STATES : string;
  ...
  attribute SOFT_HLUTNM of \sr[1]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \sr[2]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \sr[3]_i_1\ : label is "soft_lutpair33";
...
bit_controller: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_bit_ctrl
     port map (
      ...
      \FSM_sequential_c_state_reg[0]_0\ => bit_controller_n_8,
      \FSM_sequential_c_state_reg[1]\ => bit_controller_n_11,
      \FSM_sequential_c_state_reg[1]_0\ => \FSM_sequential_c_state[1]_i_2_n_0\,
      \FSM_sequential_c_state_reg[2]\ => bit_controller_n_9,
      ...
      al_reg_0 => bit_controller_n_6,
      busy_reg_0(1) => \FSM_onehot_state_reg[1]\(2),
      busy_reg_0(0) => \FSM_onehot_state_reg[1]\(0),
      c_state => c_state,
      \c_state1__0\ => \c_state1__0\,
      \c_state__0\(2 downto 0) => \c_state__0\(2 downto 0),
      cmd_ack_reg_0(1 downto 0) => cmd_ack_reg_0(1 downto 0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_top is
  ...
  attribute SOFT_HLUTNM of \stt[0]_INST_0\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \stt[1]_INST_0\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \stt[2]_INST_0\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \txr[0]_i_2\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \txr[0]_i_3\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \txr[7]_i_2\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \txr[7]_i_4\ : label is "soft_lutpair36";
begin
...
byte_controller: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_byte_ctrl
     port map (
      ...
      \FSM_onehot_state_reg[1]\(2) => \^fsm_onehot_state_reg[3]_0\(0),
      \FSM_onehot_state_reg[1]\(1) => \FSM_onehot_state_reg_n_0_[1]\,
      ...
      Q(1 downto 0) => Q(1 downto 0),
      ack_in => ack_in,
      cmd_ack_reg_0(1 downto 0) => D(1 downto 0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_config is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[1]_i_25\ : label is "soft_lutpair43";
  ...
  attribute SOFT_HLUTNM of \lut_index[5]_i_1\ : label is "soft_lutpair46";
  ...
  attribute SOFT_HLUTNM of \slv_reg0[0]_i_1\ : label is "soft_lutpair46";
...
\FSM_sequential_state[1]_i_23\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"94020294"
    )
        port map (
...
\FSM_sequential_state_reg[1]_i_2\: unisim.vcomponents.CARRY8
     port map (
      ...
      S(7) => \FSM_sequential_state[1]_i_5_n_0\,
      S(6) => \FSM_sequential_state[1]_i_6_n_0\,
      S(5) => \FSM_sequential_state[1]_i_7_n_0\,
      S(4) => \FSM_sequential_state[1]_i_8_n_0\,
...
\FSM_sequential_state_reg[1]_i_3\: unisim.vcomponents.CARRY8
     port map (
      ...
      DI(5) => state2(31),
      DI(4) => state2(31),
      DI(3) => \FSM_sequential_state[1]_i_13_n_0\,
      DI(2) => \FSM_sequential_state[1]_i_14_n_0\,
      DI(1) => \FSM_sequential_state[1]_i_15_n_0\,
      DI(0) => \FSM_sequential_state[1]_i_16_n_0\,
      O(7 downto 0) => \NLW_FSM_sequential_state_reg[1]_i_3_O_UNCONNECTED\(7 downto 0),
      S(7) => \FSM_sequential_state[1]_i_17_n_0\,
      S(6) => \FSM_sequential_state[1]_i_18_n_0\,
      S(5) => \FSM_sequential_state[1]_i_19_n_0\,
      S(4) => \FSM_sequential_state[1]_i_20_n_0\,
      S(3) => \FSM_sequential_state[1]_i_21_n_0\,
      S(2) => \FSM_sequential_state[1]_i_22_n_0\,
      S(1) => \FSM_sequential_state[1]_i_23_n_0\,
      S(0) => \FSM_sequential_state[1]_i_24_n_0\
    );
...
i2c_master_top_m0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_i2c_master_top
     port map (
      ...
      \FSM_onehot_state_reg[3]_0\(0) => i2c_write_req_done,
      \FSM_sequential_state_reg[0]\ => i2c_master_top_m0_n_2,
      \FSM_sequential_state_reg[0]_0\ => i2c_master_top_m0_n_8,
      \FSM_sequential_state_reg[0]_1\ => i2c_master_top_m0_n_9,
      \FSM_sequential_state_reg[0]_2\ => i2c_master_top_m0_n_10,
      \FSM_sequential_state_reg[0]_3\ => \FSM_sequential_state[0]_i_2_n_0\,
      \FSM_sequential_state_reg[1]\ => i2c_master_top_m0_n_15,
      \FSM_sequential_state_reg[1]_0\ => i2c_master_top_m0_n_16,
