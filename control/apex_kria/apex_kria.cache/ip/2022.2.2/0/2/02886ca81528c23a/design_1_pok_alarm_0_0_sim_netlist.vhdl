...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_pok_alarm_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single_0 is
  port (
    payload_off_alarm : out STD_LOGIC_VECTOR ( 0 to 0 );
    payload_on_out_int : out STD_LOGIC_VECTOR ( 0 to 0 );
    clk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single_0 : entity is "pok_alarm_single";
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single_0;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single_0 is
  signal \/i__n_0\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single_1 is
  port (
    payload_off_alarm : out STD_LOGIC_VECTOR ( 0 to 0 );
    payload_on_out_int : out STD_LOGIC_VECTOR ( 0 to 0 );
    clk : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single_1 : entity is "pok_alarm_single";
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single_1;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single_1 is
  signal \/i__n_0\ : STD_LOGIC;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm is
...
\pok_alarm_loop[0].pas\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single
     port map (
      clk => clk,
...
\pok_alarm_loop[1].pas\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single_0
     port map (
      clk => clk,
...
\pok_alarm_loop[2].pas\: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm_single_1
     port map (
      clk => clk,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_pok_alarm_0_0,pok_alarm,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "pok_alarm,Vivado 2022.2.2";
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pok_alarm
     port map (
      clk => clk,
